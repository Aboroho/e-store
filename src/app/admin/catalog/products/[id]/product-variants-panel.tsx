...
export function ProductVariantsPanel({
  ...
  const [editing, setEditing] = React.useState<PersistedVariantSnapshot | null>(null);
  ...
  return (
    <div className="space-y-3">
      ...
      {productPreorder ? (
        <p className="px-4 text-xs text-slate-500">Preorder is on for this product — any variant can be pre-ordered.</p>
      ) : null}
