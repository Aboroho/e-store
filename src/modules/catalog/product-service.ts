...
export async function saveProductDraft(
  ...
  // Autosave writes ProductDraft only. It must not mutate the live Product —
  // explicit Save/Update is the only path that commits catalogue data.
...
export async function discardProductDraft(
  ...
  // Discarding a working copy must never bin or delete the real product.
