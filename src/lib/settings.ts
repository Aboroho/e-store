...
export const BUSINESS_SETTINGS = {
  ...
  mediaAllowedTypes: define({ key: "media.allowed_types", label: "Allowed file types", description: "MIME types accepted by the media manager.", group: "Media", defaultValue: ["image/jpeg", "image/png", "image/webp", "image/avif", "image/gif", "application/pdf", "text/csv", "video/mp4", "video/webm"], valueType: "JSON" }),
